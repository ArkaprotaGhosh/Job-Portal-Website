...
const Footer = () => {
  return (
    <>
      <section>
        <footer class="footer d-flex text-center align-items-center justify-content-center bg-light py-5" style={{ minHeight: "40vh" }}>
          <div class="container">
            <div class="row justify-content-center mb-2">
            </div>
            <div class="row justify-content-center align-items-center">
              <div class="col-md-4" style={{ color: "black", textAlign:"left"}}>
                <ul style={{ listStyleType: "none", color: "black", textAlign:"left"}}>
